...
class Booking extends Model
{
    ...
    protected $fillable = ['time_from', 'time_to', 'additional_information',
                           'customer_id', 'room_id','amount','status',
                           'items_total','discount','total_amount', 'check_in_time',
                           'check_out_time', 'payment_status', 'mode', 'card_no', 'paytm_no',
                            'upi_id', 'google_pay', 'phone_pay', 'time'];
